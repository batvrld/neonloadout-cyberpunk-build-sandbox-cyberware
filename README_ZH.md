...
- **属性预算场景** (Attribute budget scenarios) — 规划模块，尚未实现。
- **装备测试矩阵** (Equipment test matrix) — 规划模块，尚未实现。
- **扩展版本记录** (Expansion version register) — 规划模块，尚未实现。
