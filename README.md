...
<div align="center">
  <img src="./public/logo.svg" alt="NeonLoadout — Cyberpunk 2077 — Cyberware" width="64" height="64">
  <h1>NeonLoadout — Cyberpunk 2077 — Cyberware</h1>
</div>

An independent project specification for Cyberpunk 2077, covering attribute budget scenarios, equipment test matrix, expansion version register.
...
<img src="./public/screenshots/desktop-main.svg" alt="Cyberpunk 2077 — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Cyberpunk 2077 — compact concept, not a screenshot" width="250">
<br>
...
- **Attribute budget scenarios** — planned module; not implemented.
- **Equipment test matrix** — planned module; not implemented.
- **Expansion version register** — planned module; not implemented.

The proposed workflow separates attribute budget scenarios from equipment test matrix, with expansion version register retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Attribute budget scenarios**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="NeonLoadout — Cyberpunk 2077 — Cyberware — specification review workflow">
<br>
...
### Attribute budget scenarios

Define the input and expected outcome for module 1. Record the Cyberpunk 2077 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Equipment test matrix

Define the input and expected outcome for module 2. Record the Cyberpunk 2077 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Expansion version register

Define the input and expected outcome for module 3. Record the Cyberpunk 2077 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Attribute budget scenarios |
